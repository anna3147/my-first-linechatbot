...
def handle_message(event):
    with ApiClient(configuration) as api_client:
        ...
        bot_msg = TextMessage(text=f"收到了你的訊息是：{user_msg}")

        # if user_msg == "電話":
        #     bot_msg = TextMessage(text="02-8101-0000")
        
        # elif user_msg == "營業時間":
        #     bot_msg = TextMessage(text="早上11點到晚上9點")
        
        # elif user_msg == "地址":
        #     bot_msg = LocationMessage(
        #         title = "台北101",
        #         address = "台北市信義區信義路五段7號",
        #         latitude = 25.034257884674602,
        #         longitude = 121.56447452238778,

        #     )
        # 當使用者輸入的文字作為 faq 的 key 時，將value 作為 bot_msg
        if user_msg in faq:
            ...
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": "你是一個說話很毒的朋友，可以有趣的答覆使用者提供的問題"},
                {
                    "role": "user",
                    "content": user_msg
                }
